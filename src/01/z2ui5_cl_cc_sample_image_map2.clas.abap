...
CLASS Z2UI5_CL_CC_SAMPLE_IMAGE_MAP2 IMPLEMENTATION.
  ...
  METHOD z2ui5_on_event.
        DATA temp1 TYPE REF TO z2ui5_cl_cc_sample_image_map.

    CASE client->get( )-event.
      WHEN 'GO_TO_EDITOR'.
        
        CREATE OBJECT temp1 TYPE z2ui5_cl_cc_sample_image_maP EXPORTING b64_image = mv_value filename = mv_path.
